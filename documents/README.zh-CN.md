...
MiniPdf 的输出结果以 LibreOffice 作为参考渲染器，针对 **120 个经典测试用例**（包括 30 个图片嵌入用例和 30 个图表用例）进行比较。
...
**整体平均分数：94.7%** （文字相似度 40% + 视觉相似度 40% + 页数 20%）

### 视觉对比

以下为全部测试用例的对比，MiniPdf 输出 vs LibreOffice 参考结果。多页结果仅显示第 1 页。
