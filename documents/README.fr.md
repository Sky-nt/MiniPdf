...
La sortie de MiniPdf est comparée à LibreOffice comme moteur de rendu de référence sur **120 cas de test classiques** (dont 30 cas d'images intégrées et 30 cas de graphiques).
...
**Score moyen global : 94,7%** (similarité textuelle 40% + similarité visuelle 40% + nombre de pages 20%)

### Comparaison visuelle

Tous les cas de test comparant la sortie MiniPdf et la référence LibreOffice. La page 1 est affichée pour les résultats multi-pages.
