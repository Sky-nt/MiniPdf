...
Une bibliothèque .NET minimale et sans dépendance pour convertir des fichiers Office en PDF.
...
La sortie de MiniPdf est comparée à LibreOffice comme moteur de rendu de référence sur **180 cas de test classiques** (dont 30 cas d'images intégrées, 30 cas de graphiques, 30 cas de style et 30 cas multilingues/emoji).
...
**Score moyen global : 96.5%** (similarité textuelle 40% + similarité visuelle 40% + nombre de pages 20%)
