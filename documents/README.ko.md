...
MiniPdf 출력은 LibreOffice를 참조 렌더러로 하여 **120개의 클래식 테스트 케이스**(이미지 임베딩 30개, 차트 30개 포함)와 비교됩니다.
...
**전체 평균 점수: 94.7%** (텍스트 유사도 40% + 시각적 유사도 40% + 페이지 수 20%)

### 시각적 비교

MiniPdf 출력과 LibreOffice 참조를 비교한 전체 테스트 케이스. 여러 페이지의 경우 1페이지만 표시.
