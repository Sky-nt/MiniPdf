...
MiniPdf DOCX output is compared against LibreOffice as the reference renderer across **120 classic test cases**.
...
**Average overall score: 97.0%** (text similarity 40% + visual similarity 40% + page count 20%)
