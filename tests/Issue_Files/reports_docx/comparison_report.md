...
Generated: 2026-03-18T17:05:07.844088

## Summary

| # | Test Case | Text Sim | Visual Avg | Pages (M/R) | Overall |
|---|-----------|----------|------------|-------------|--------|
| 1 | 🟡 Class News | 0.7718 | 0.8732 | 4/4 | **0.858** |
| 2 | 🟢 Confirmatory_Affidavit | 1.0 | 0.9761 | 2/2 | **0.9904** |
| 3 | 🟢 Invoice | 1.0 | 0.913 | 1/1 | **0.9652** |
| 4 | 🟡 MODERN LIVING | 0.7813 | 0.7787 | 2/2 | **0.824** |
| 5 | 🟢 OSCAR WARD | 0.9941 | 0.8528 | 1/1 | **0.9388** |
| 6 | 🟢 SA8000 ch sample | 0.9365 | 0.9209 | 3/3 | **0.943** |
| 7 | 🟢 Support_Letter | 1.0 | 0.95 | 1/1 | **0.98** |

**Average Overall Score: 0.9285**
...
<tr>
  ...
  <td colspan="1">Class News <span style="color:#d29922">⬤</span> 85.8%</td>
</tr>
<tr>
...
<tr>
  ...
  <td colspan="1">Confirmatory_Affidavit <span style="color:#3fb950">⬤</span> 99.0%</td>
</tr>
<tr>
...
<tr>
  <td><b>Invoice</b></td>
  <td colspan="1">Invoice <span style="color:#3fb950">⬤</span> 96.5%</td>
</tr>
<tr>
...
<tr>
  ...
  <td colspan="1">MODERN LIVING <span style="color:#d29922">⬤</span> 82.4%</td>
</tr>
<tr>
...
<tr>
  ...
  <td colspan="1">SA8000 ch sample <span style="color:#3fb950">⬤</span> 94.3%</td>
</tr>
<tr>
...
<tr>
  ...
  <td colspan="1">Support_Letter <span style="color:#3fb950">⬤</span> 98.0%</td>
</tr>
<tr>
...
- **Text Similarity:** 0.7718
- **Visual Average:** 0.8732
- **Overall Score:** 0.858
- **Pages:** MiniPdf=4, Reference=4
- **File Size:** MiniPdf=241523 bytes, Reference=147827 bytes
...
-dictum mi sit amet, aliquam mi. Sus
... (9288 more characters)
...
- **File Size:** MiniPdf=4829 bytes, Reference=91848 bytes
...
- **File Size:** MiniPdf=20032 bytes, Reference=65867 bytes
...
- **Text Similarity:** 0.7813
- **Visual Average:** 0.7787
- **Overall Score:** 0.824
- **Pages:** MiniPdf=2, Reference=2
- **File Size:** MiniPdf=321830 bytes, Reference=220316 bytes
...
-with information about your product or blog. They can be printed or subscribers interested in your topic

-emailed and are an excellent way to maintain regular contact with your
...
- **Visual Average:** 0.8528
- **Overall Score:** 0.9388
- **Pages:** MiniPdf=1, Reference=1
- **File Size:** MiniPdf=13869 bytes, Reference=49023 bytes
...
- **Text Similarity:** 0.9365
- **Visual Average:** 0.9209
- **Overall Score:** 0.943
- **Pages:** MiniPdf=3, Reference=3
- **File Size:** MiniPdf=4178830 bytes, Reference=159484 bytes
...
-1、一个管理十分严谨、设备精良并经消防主管部门审批合格的油库，在加强日常管理的情
...
- **Overall Score:** 0.98
- **Pages:** MiniPdf=1, Reference=1
- **File Size:** MiniPdf=4159 bytes, Reference=61824 bytes
